...
sewers: typing.List[LocationData] = [
    ...
    LocationData("Rogueport Sewers Black Chest Room: Plane Mode", 78780153, Rels.tik, [0x2D65C]),
...
hooktails_castle: typing.List[LocationData] = [
    ...
    LocationData("Hooktail's Castle Prison Entrance: Paper Mode", 78780204, Rels.gon, [0xF504]),
    LocationData("Hooktail's Castle Prison Entrance: Attack FX R", 78780205, Rels.gon, [0xFD5C]),
    LocationData("Hooktail's Castle Spikes Room: Black Key (Paper)", 78780206, Rels.gon, [0x1026C]),
...
twilight_town_region: typing.List[LocationData] = [
    ...
    LocationData("Twilight Town Rightside: Tube Mode", 78780318, Rels.usu, [0x162E8]),
    LocationData("Twilight Trail Entrance: 10 Coins", 78780319, Rels.gra, [0x4A38]),
    LocationData("Twilight Trail Entrance: Black Key (Tube)", 78780320, Rels.gra, [0x4A60]),
...
pirates_grotto: typing.List[LocationData] = [
    ...
    LocationData("Pirate's Grotto Chest Boat: Black Key (Boat)", 78780505, Rels.dou, [0xC464, 0xB64C]),
    LocationData("Pirate's Grotto Chest Boat: Boat Mode", 78780506, Rels.dou, [0xBE8C]),
...
palace: typing.List[LocationData] = [
    ...
    LocationData("Riddle Tower Floor 1 NW: Palace Key (Tower)", 78780614, Rels.las, [0x251E8]),
    LocationData("Riddle Tower Floor 1 NE: Palace Key (Tower)", 78780615, Rels.las, [0x25690]),
    LocationData("Riddle Tower Floor 1 SW: Palace Key (Tower)", 78780616, Rels.las, [0x25AC0]),
    LocationData("Riddle Tower Floor 1 SE: Palace Key (Tower)", 78780617, Rels.las, [0x26008]),
    LocationData("Riddle Tower Floor 2 NW: Palace Key (Tower)", 78780618, Rels.las, [0x26438]),
    LocationData("Riddle Tower Floor 2 NE: Palace Key (Tower)", 78780619, Rels.las, [0x268E0]),
    LocationData("Riddle Tower Floor 2 SW: Palace Key (Tower)", 78780620, Rels.las, [0x26F40]),
    LocationData("Riddle Tower Floor 2 SE: Palace Key (Tower)", 78780621, Rels.las, [0x27600]),
