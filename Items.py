...
itemList: typing.List[ItemData] = [
    ...
    ItemData(77772053, "Elevator Key (X-Naut Fortress) 1", ItemClassification.progression),
    ItemData(77772054, "Elevator Key (X-Naut Fortress) 2", ItemClassification.progression),
...
item_type_dict = {
    ...
    "Station Key 2": 0x19,
    "Elevator Key": 0x1A,
    "Elevator Key (X-Naut Fortress) 1": 0x1B,
    "Elevator Key (X-Naut Fortress) 2": 0x1C,
    "Card Key 1": 0x1D,
    "Card Key 2": 0x1E,
    "Card Key 3": 0x1F,
    "Card Key 4": 0x20,
